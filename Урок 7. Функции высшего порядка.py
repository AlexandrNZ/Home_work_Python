...
# def rhythm(input_str):
#     split_line = list(input_str.split())
#     count = len(set(sum(map(lambda x: x in vowels, i))for i in split_line))
#     return "Парам пам-пам" if count < 2 else "Пам парам "
    
# vowels = ['а', 'о', 'э', 'е', 'и', 'ы', 'у', 'ё', 'ю', 'я']
# my_line = "Пара-ра-рам рам-пам-папам па-ра-па-да"
# # my_line = input("Введите строку: ")
# print(rhythm(my_line))
